  ...
  <v-card ref="form">
    <v-card-text>
      ...
      <v-text-field
        ref="nokenda"
        v-model="address"
        :rules="[() => !!address || 'No Kendaraan tidak boleh kosong']"
      ...
      <v-text-field
        ref="Nama Peminta"
        v-model="address"
        :rules="[() => !!address || 'Nama Peminta tidak boleh kosong']"
        label="Nama Peminta"
        placeholder="Albunny"
        required
        filled
      ...
      <v-text-field
        ...
        filled
        rounded
        class="v-text-field fieldset v-text-field v-input__control v-text-field v-input__slot v-input__slot_height"
      ></v-text-field>
    </v-card-text>
